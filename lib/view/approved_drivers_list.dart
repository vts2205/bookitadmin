...
class _DriverListPageState extends State<DriverListPage> {
  ApprovedDriversListModel approvedDriversListModel;
  ...
  getData() async {
    approvedDriversListModel = (await APIService().approvedDriversList());
    if (approvedDriversListModel != null) {
      setState(() {
        isLoading = true;
      });
    }
        ...
        child: Visibility(
          ...
          child: isLoading == false
              ...
              : DataTable2(
                  ...
                  rows: approvedDriversListModel.body.approvedDrivers
                      .map((e) => DataRow(cells: [
                            DataCell(CustomText(
                              text: (e.driverId),
                              size: 12,
